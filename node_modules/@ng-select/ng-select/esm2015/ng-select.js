...
class ItemsList {
    ...
    _groupBy(items, prop) {
        ...
        const /** @type {?} */ groups = items.reduce((grouped, item) => {
            let /** @type {?} */ key = isFn ? (/** @type {?} */ (prop)).apply(this, [item.value]) : item.value[/** @type {?} */ (prop)];
            key = key || undefined;
    ...
    _flatten(groups) {
        const /** @type {?} */ isFn = isFunction(this._ngSelect.groupBy);
        const /** @type {?} */ items = [];
        const /** @type {?} */ withoutGroup = groups.get(undefined) || [];
        items.push(...withoutGroup);
        let /** @type {?} */ i = withoutGroup.length;
        for (const /** @type {?} */ key of Array.from(groups.keys())) {
            if (!key) {
                continue;
            }
            const /** @type {?} */ parent = {
...
export { NgSelectComponent, NG_SELECT_DEFAULT_CONFIG, NgSelectModule, ConsoleService as ɵo, NgDropdownPanelComponent as ɵk, NgOptionHighlightDirective as ɵp, NgOptionComponent as ɵn, NgFooterTemplateDirective as ɵf, NgHeaderTemplateDirective as ɵe, NgLabelTemplateDirective as ɵc, NgLoadingTextTemplateDirective as ɵi, NgMultiLabelTemplateDirective as ɵd, NgNotFoundTemplateDirective as ɵg, NgOptgroupTemplateDirective as ɵb, NgOptionTemplateDirective as ɵa, NgTagTemplateDirective as ɵj, NgTypeToSearchTemplateDirective as ɵh, VirtualScrollService as ɵl, WindowService as ɵm };
