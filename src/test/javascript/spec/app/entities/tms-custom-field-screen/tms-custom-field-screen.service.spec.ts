...
describe('Service Tests', () => {
    ...
    describe('TMSCustomFieldScreen Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TMSCustomFieldScreenService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tms-custom-field-screens';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TMSCustomFieldScreen', () => {
