...
describe('Service Tests', () => {
    ...
    describe('TaskBiddingTrackingTime Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TaskBiddingTrackingTimeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/task-bidding-tracking-times';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TaskBiddingTrackingTime', () => {
