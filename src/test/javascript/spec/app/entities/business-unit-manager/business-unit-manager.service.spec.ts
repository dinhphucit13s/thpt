...
describe('Service Tests', () => {
    ...
    describe('BusinessUnitManager Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BusinessUnitManagerService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/business-unit-managers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BusinessUnitManager', () => {
