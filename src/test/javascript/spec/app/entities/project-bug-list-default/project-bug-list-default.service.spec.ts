...
describe('Service Tests', () => {
    ...
    describe('ProjectBugListDefault Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProjectBugListDefaultService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/project-bug-list-defaults';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProjectBugListDefault', () => {
