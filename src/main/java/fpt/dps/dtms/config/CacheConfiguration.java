...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        String instanceName = env.getProperty("spring.jpa.properties.hibernate.cache.hazelcast.instance_name");
        String hazelcastDiscoveryEnabled = env.getProperty("spring.jpa.properties.hibernate.cache.hazelcast.discovery.enabled");
        ...
        config.setProperty("hazelcast.discovery.enabled", hazelcastDiscoveryEnabled);
        ...
        config.getNetworkConfig().getJoin().getMulticastConfig().setEnabled(false);
        config.getMapConfigs().put("fpt.dps.dtms.domain.*", initializeDomainMapConfig(jHipsterProperties));
