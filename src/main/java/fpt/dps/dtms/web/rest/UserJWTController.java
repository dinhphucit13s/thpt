...
public class UserJWTController {
    ...
    public UserJWTController(TokenProvider tokenProvider, AuthenticationManager authenticationManager, UserService userService, LoginTrackingService loginTrackingService) {
