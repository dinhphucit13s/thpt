...
import fpt.dps.dtms.service.CustomerService;
...
public class CustomerResource {
    ...
    @Timed
    @PreAuthorize("@jhiAuth.hasPermission('CUSTOMER', 'CREATE')")
    ...
    @Timed
    @PreAuthorize("@jhiAuth.hasPermission('CUSTOMER', 'EDIT')")
    ...
    @Timed
    @PreAuthorize("@jhiAuth.hasPermission('CUSTOMER', 'VIEW')")
    ...
    @Timed
    @PreAuthorize("@jhiAuth.hasPermission('CUSTOMER', 'DELETE')")
    public ResponseEntity<Void> deleteCustomer(@PathVariable Long id) {
        ...
        try {
        	...
        	return ResponseEntity.badRequest().headers(HeaderUtil.serviceFailureAlert(ENTITY_NAME, AppConstants.IN_USED, "A customer cannot delete")).build();
        }        
    }
