...
import fpt.dps.dtms.web.rest.errors.*;
import fpt.dps.dtms.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
     ...
     */
    @PostMapping(path = "/account/change-password-user")
    @Timed
    public void changePasswordUser(@RequestParam String password, @RequestParam String user) {
        if (!checkPasswordLength(password)) {
            throw new InvalidPasswordException();
        }
        userService.changePasswordUser(password, user);
   }
