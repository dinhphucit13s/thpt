...
import fpt.dps.dtms.web.websocket.dto.ActivityDTO;
...
import static fpt.dps.dtms.config.WebsocketConfiguration.IP_ADDRESS;
...
public class ActivityService implements ApplicationListener<SessionDisconnectEvent> {
    ...
    public ActivityService(SimpMessageSendingOperations messagingTemplate, UserService userService, LoginTrackingService loginTrackingService) {
    ...
    public void onApplicationEvent(SessionDisconnectEvent event) {
    	...
    	this.loginTrackingService.updateLoginTracking(principal.getName());
