...
export class NotificationService {
    ...
    getNotificationList(userName: any, modeViewNotify: any, req?: any): Observable<HttpResponse<any[]>> {
        const options = createRequestOption(req);
        return this.http.get<any[]>(`${this.resourceUrl}/${userName}/${modeViewNotify}`, { params: options, observe: 'response' });
    }

    deleteMultiNotification(notificationPayload: any): Observable<HttpResponse<any>> {
        return this.http.post<any>(`${this.resourceUrl}/deleteMulti`, notificationPayload, {observe: 'response'});
    }

    countNotificationUnread(userLogin: any) {
        return this.http.get(`${this.resourceUrl}/${userLogin}/count-unread`, { observe: 'response'});
    }
